...
<section id="home">
  ...
  <div class="hero-inner">
    ...
    <div class="hero-text reveal">
      ...
      <div class="btn-row">
        <a href="resume/Madhu_software_developer.pdf" target="_blank" class="btn btn-primary">
          ↓ Download CV
        </a>
    ...
    <div class="hero-photo-col reveal d2">
      <div class="photo-ring">
        <div class="photo-ring-inner">
          <img src="photos/photo.jpg" alt="Madhu Saravanan" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="about-grid">
      ...
      <div class="about-text reveal-r">
        ...
        <a href="resume/Madhu_software_developer.pdf" target="_blank" class="btn btn-primary" style="align-self:flex-start;">
          View Resume ↗
        </a>
      </div>
    </div>
        ...
        <div class="form-card">
          ...
          <?php
            if (isset($_SESSION['flash'])) {
              if ($_SESSION['flash'] === 'ok') {
                echo '<p class="flash ok">✅ Message sent! I\'ll get back to you soon.</p>';
              } else {
                echo '<p class="flash err">❌ Something went wrong. Please try again or email directly.</p>';
              }
              unset($_SESSION['flash']);
            }
          ?>

          <form id="contactForm" action="/portfolio/contact" method="POST" novalidate>
            <div class="form-2col">
              <div class="field">
